# Generated by Django 5.2.2 on 2025-06-09 10:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_id', models.CharField(blank=True, max_length=6, unique=True)),
                ('dob', models.DateField(blank=True, null=True)),
                ('address', models.CharField(choices=[('Borivali', 'Borivali'), ('Andheri', 'Andheri'), ('Dadar', 'Dadar'), ('Bandra', 'Bandra'), ('Churchgate', 'Churchgate')], max_length=100)),
